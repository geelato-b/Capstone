  ...
  <div id="wrapper">
   <div class="overlay"></div>
	...
	<ul class="navbar-nav align-self-stretch">
	  ...
	  <li class=""> 
      <a href="" class="nav-link text-left active"  role="button"><i class="bi bi-house-door"></i>Dashboard </a>
		  </li>
          <li><a href="" class="nav-link text-left"  role="button"> <i class="bi bi-person-fill"></i>Students</a></li>
          ...
          <li><a href="" class="nav-link text-left"  role="button"><i class="bi bi-file-plus-fill"></i>Update</a></li>
